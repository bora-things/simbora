...
supervisor = create_supervisor(
    ...
    prompt=(
        ...
        "- um agente de RAG. Atribua tarefas relacionadas à dúvidas gerais da UFRN (como PPCs de cursos, FAQs, regulamentos) para este agente\n"
        "- um agente consumidor da API do SIGAA. Atribua tarefas relacionadas à informações dinâmicas da UFRN como notícias, calendários acadêmicos, avaliações de docentes, componentes curriculares para este agente\n"
